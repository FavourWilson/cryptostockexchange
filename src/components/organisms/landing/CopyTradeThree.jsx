          ...
          <div className="grid items-center md:grid-cols-2 md:gap-x-20 gap-y-10">
            ...
            <div className="md:order-2 lg:pl-16 lg:pr-10 md:pl-0 xl:pr-0">
              <h2 className="text-2xl font-bold leading-tight text-black sm:text-3xl lg:text-3xl text-center lg:text-left">
                Trade the names you know, with a name you can trust
              </h2>
              <p className="mt-4 text-base text-center lg:text-left py-2 lg:py-0 leading-relaxed text-gray-600">
                Buy and sell bitcoin and ethereum in the same app where you
                trade stocks — for as little as $1. All with a leader in crypto
                for nearly a decade: Crypto Stock Exchanges Digital Assets℠
              </p>
